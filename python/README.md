...
```sh
pipx install missu      # or: uv tool install missu
uvx missu               # or run it without installing
```
...
binary, `brew install glimpsed-io/tap/missu` and `scoop install missu` ship one.
